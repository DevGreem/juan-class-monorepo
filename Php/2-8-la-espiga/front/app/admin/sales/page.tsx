...
export default async function SalesAdminPage() {
  ...
  if (!rawUser || typeof rawUser !== "string") {
    redirect("/login?redirect=/admin/sales");
  }
    ...
    <div className="min-h-screen bg-linear-to-br from-stone-50 via-amber-50 to-white px-6 py-12 sm:px-10">
      <div className="mx-auto flex max-w-6xl flex-col gap-8">
        <div className="flex flex-col gap-2">
          ...
          <h1 className="text-4xl font-semibold text-stone-950 sm:text-5xl">Ventas</h1>
          <p className="max-w-3xl text-base leading-7 text-stone-700">
            Panel de ventas para administradores. Datos cargados desde la API de Laravel.
          </p>
        </div>
